...
if TYPE_CHECKING:
    from strike.telemetry.tracer import Tracer
...
from strike.llm import LLM, LLMConfig, LLMRequestFailedError
from strike.llm.utils import clean_content
from strike.runtime import SandboxInitializationError
from strike.tools import process_tool_invocations
from strike.utils.resource_paths import get_strike_resource_path
...
class AgentMeta(type):
    ...
    def __new__(cls, name: str, bases: tuple[type, ...], attrs: dict[str, Any]) -> type:
        ...
        prompt_dir = get_strike_resource_path("agents", name)
...
class BaseAgent(metaclass=AgentMeta):
    ...
    async def _wait_for_input(self) -> None:
        ...
        if self.state.has_waiting_timeout():
            ...
            try:
                from strike.tools.agents_graph.agents_graph_actions import _agent_graph
    ...
    async def _initialize_sandbox_and_state(self, task: str) -> None:
        ...
        sandbox_mode = os.getenv("STRIKE_SANDBOX_MODE", "false").lower() == "true"
        if not sandbox_mode and self.state.sandbox_id is None:
            from strike.runtime import get_runtime
            ...
            try:
                ...
                from strike.telemetry import posthog
    ...
    def _check_agent_messages(self, state: AgentState) -> None:  # noqa: PLR0912
        try:
            from strike.tools.agents_graph.agents_graph_actions import _agent_graph, _agent_messages
