...
from strike.tools.registry import register_tool
...
def _load_primary_wiki_note(agent_state: Any | None = None) -> dict[str, Any] | None:
    try:
        from strike.tools.notes.notes_actions import get_note, list_notes
...
def _append_wiki_update_on_finish(
    ...
    try:
        from strike.tools.notes.notes_actions import append_note_content
...
def create_agent(
    ...
    try:
        ...
        from strike.skills import parse_skill_list, validate_requested_skills
        ...
        from strike.agents import StrikeAgent
        from strike.agents.state import AgentState
        ...
        agent = StrikeAgent(agent_config)
