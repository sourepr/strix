...
from strike.config.config import Config, resolve_llm_config
...
class MemoryCompressor:
    def __init__(
        ...
        self.model_name = model_name or Config.get("strike_llm")
        self.timeout = timeout or int(Config.get("strike_memory_compressor_timeout") or "120")

        if not self.model_name:
            raise ValueError("STRIKE_LLM environment variable must be set and not empty")
